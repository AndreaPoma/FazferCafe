...
let contenidoDeBebidas = document.getElementById('contenidoDeBebidas');
    ...
    fetch('dataBebidas.json')
        ...
        .then((data) => {
           ...
           <p> ${hola.precio} </p>
            ...
            document.getElementById('contenidoDeBebidas').innerHTML = html;
        })
}
...
function ImprimirComentariosEnPantalla(){
    db.collection("comentarios").get().then((querySnapshot) => {
        ...
        querySnapshot.forEach((doc) => {
            ...
            var listarDatos = `
            <div>
            <li class="listarDatos color" style="border-radius: 10px;">
